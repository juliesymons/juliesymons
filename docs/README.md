...
The documentation of Cog operators and functions in the following pages was generated by Scaladoc2, a tool that extracts and formats their description directly from the source code.  The descriptions that follow are organized in three parts:
